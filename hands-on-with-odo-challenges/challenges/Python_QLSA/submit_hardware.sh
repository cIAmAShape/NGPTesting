...
# Run on simulator
#srun -N1 -n1 -c2 python solver.py -case sample-tridiag -casefile input_vars.yaml -s 500 -backtyp ideal --savedata
...
# Run on real device
#source keys.sh    DO YOUR OWN KEYS BEFORE DOING HARDWARE
srun -N1 -n1 -c2 python solver.py -case sample-tridiag -casefile input_vars.yaml -s 1000 -backtyp real-iqm -backmet emerald --savedata
