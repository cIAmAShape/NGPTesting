...
f = h5py.File('galaxy.hdf5', 'w', driver='mpio', comm=comm )# TO-DO
dset_pos_pt  = f.create_dataset("pos_pt",  data= dummy_data )# TO-DO
dset_vel_pt  = f.create_dataset("vel_pt",  data= dummy_data )# TO-DO
dset_pos_nuc = f.create_dataset("pos_nuc", data= dummy_nuc )# TO-DO
dset_vel_nuc = f.create_dataset("vel_nuc", data= dummy_nuc )# TO-DO
